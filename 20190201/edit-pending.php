               ...
               <div class="sidebar-overlay" id="sidebar-overlay"></div>
                <article class="content responsive-tables-page">
                    <div class="title-block">
                        <h1 class="title">
		Editing pending funds
	</h1><p class="title-description"> Editing the funds that are pennding to be paid/invested </p>
                    </div>
...
$stmt = $user_home->runQuery("UPDATE tbl_history SET amount=:user_price WHERE traceid=:uid");
...
$id = $_GET['trace'];     
$stmt = $user_home->runQuery("SELECT * FROM tbl_history WHERE traceid=:uid");
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <section class="example">
                                            ...
                                            <div class="form-group"> <label class="control-label">Donor</label> <input type="text" name="name" value="<?php echo $row['hfrom']; ?>" class="form-control underlined" required> </div>
                                      
                                            <div class="form-group"> <label class="control-label">Amount</label> <input type="text" name="amount" value="<?php echo $row['amount']; ?>" class="form-control underlined" required> </div>
