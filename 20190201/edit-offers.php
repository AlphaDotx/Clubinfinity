               ...
               <div class="sidebar-overlay" id="sidebar-overlay"></div>
                <article class="content responsive-tables-page">
                    <div class="title-block">
                        <h1 class="title">
		Editing offered funds
	</h1><p class="title-description"> Editing the funds that are pending to be paid/invested </p>
                    </div>
...
$stmt = $user_home->runQuery("UPDATE tbl_helpers SET price=:user_price WHERE traceid=:uid");
$stmt->execute(array(":user_price"=>$price,":uid"=>$traceid));
				
$msg = "<div class='alert alert-success'>
New changes are successfully saved on offered pending funds.
</div>";              
}
?>
...
$id = $_GET['trace'];     
$stmt = $user_home->runQuery("SELECT * FROM tbl_helpers WHERE traceid=:uid");
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-block">
                                     ...
                                     <a href="investors.php" class="btn btn-secondary">Cancel</a>  
