...
class MyMobileAPI{
    public function __construct() {
        ...
        $this->username = 'Infinitewealth'; //your login username
        $this->password = 'mongwe1'; //your login password
    }
...
$test->sendSms($numbers,'Message goes here'); //Send SMS
//$test->checkcredits(); //Check your credit balance

}

header('location: shout-out.php?code=600');
