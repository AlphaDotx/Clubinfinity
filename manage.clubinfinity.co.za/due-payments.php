                            ...
                            <ul class="nav metismenu" id="sidebar-menu">
                                ...
                                <li class="active open">
    								...
    								Investments
                                        ...
                                        <li class="active"> <a href="payments.php"><i class="fa fa-caret-right"></i> &nbsp;
    								Due Payments
    							</a> </li>
                                    </ul>
...
<!--button type="submit" class="btn btn-warning-outline"  onClick="setUpdateAction();" >Pay Selected</button--> 
                                                ...
                                                <table class="table table-striped table-bordered table-hover flip-content">
                                                    ...
                                                    <tbody>
<?php                                
$stmt = $user_home->runQuery("SELECT * FROM tbl_orders ORDER BY `tbl_orders`.`date` DESC");
...
<div class="dropdown-divider"></div-->    
<li><a href="edit-due.php?trace=<?php echo $row['traceid']; ?>">&nbsp;&nbsp;<i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a></li>
<div class="dropdown-divider"></div>
