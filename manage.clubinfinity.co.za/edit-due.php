                            ...
                            <ul class="nav metismenu" id="sidebar-menu">
                                ...
                                <li class="active open">
    								...
    								Investments
                                        ...
                                        <li class="active"> <a href="due-payments.php"><i class="fa fa-caret-right"></i> &nbsp;
    								Due Payments
    							</a> </li>
                                    </ul>
               ...
               <div class="sidebar-overlay" id="sidebar-overlay"></div>
                <article class="content responsive-tables-page">
                    <div class="title-block">
                        <h1 class="title">
		Editing Matured funds
	</h1><p class="title-description"> Editing the funds that are pending to be allocated </p>
                    </div>
...
$stmt = $user_home->runQuery("UPDATE tbl_orders SET price=:user_price WHERE traceid=:uid");
$stmt->execute(array(":user_price"=>$price,":uid"=>$traceid));
				
$msg = "<div class='alert alert-success'>
New changes are successfully saved on matured funds.
</div>";              
}
?>
...
$id = $_GET['trace'];     
$stmt = $user_home->runQuery("SELECT * FROM tbl_orders WHERE traceid=:uid");
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-block">
                                     ...
                                     <a href="due-payments.php" class="btn btn-secondary">Cancel</a>  
