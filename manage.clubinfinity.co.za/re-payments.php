    ...
    <body>
        <div class="main-wrapper">
                        ...
                        <nav class="menu">
                            <ul class="nav metismenu" id="sidebar-menu">
                                <li>
    								...
    								R200s
    							</a> </li><li> <a href="due-payments.php"> <i class="fa fa-caret-right"></i> &nbsp;
    								Withdrawn Funds
    							</a> </li>
                                    </ul>
            ...
            Referral Funds
                        ...
                        <p class="title-description"> This panel consists of the referral funds that are made before PH. </p>
                    </div>
...
if($_GET['code']==700){
 echo '<div class="alert alert-success fade in">
         <strong>Success!</strong> Your payment confirmation was successful</a>.
      </div>';   
}             
}
?>
...
$stmt = $user_home->runQuery("SELECT * FROM tbl_temp_helpers WHERE  name like '%$search%' || date like '%$search%'");
...
<a href="confirm_ph.php?trace=<?php echo $row['userID']; ?>" class="btn btn-warning-outline btn-sm" >Confirm</a>      
</td>
