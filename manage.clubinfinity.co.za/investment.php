...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title> Administrator Panel - My Investment </title>
...
Invested Funds
                        ...
                        <p class="title-description"> This panel consists of the funds invested on the system. </p>
                    </div>
...
if($_GET['code']==600){
 echo '<div class="alert alert-info fade in">
         <strong>Success!</strong> The invested funds record is successfully withdrawn </a>.
      </div>';   
}             
}
?> 
...
$stmt = $user_home->runQuery("SELECT * FROM tbl_waitinglist WHERE  traceid like '%$search%' || name like '%$search%' || date like '%$search%' ORDER BY `tbl_waitinglist`.`date` DESC");
